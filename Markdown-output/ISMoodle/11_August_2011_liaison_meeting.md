...
-   [Minutes](#Minutes)
    -   [Moodle](#Moodle)
        -   [Issues](#Issues)
        -   [Moodle-Archive](#Moodle-Archive)
        -   [Developments](#Developments)
            -   [Turnitin](-Turnitin)
                -   [Testing](-Testing)
                -   [Hacks proposed](-Hacksproposed)
                -   [UI Administrator setting](-UIAdministratorsetting)
                -   [Go live date](-Golivedate)
            -   [SITs Filter](-SITsFilter)
                -   [Testing](-Testing.1)
                -   [Roll back (if things go wrong)](-Rollback(ifthingsgowrong))
                -   [Go Live Date](-GoLiveDate)
                -   [Moodle development priorities (carried over from last meeting)](-Moodledevelopmentpriorities(carriedoverfromlastmeeting))
    -   [Lecturecast (Jo)](-Lecturecast(Jo))
        -   [Issues](-Issues.1)
        -   [Developments](-Developments.1)
            -   [Web interface to display events for departments](-Webinterfacetodisplayeventsfordepartments)
            -   [Automatic creation of schedules from CMIS data](-AutomaticcreationofschedulesfromCMISdata)
